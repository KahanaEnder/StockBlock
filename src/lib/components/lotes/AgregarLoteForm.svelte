...
<div class="card-glass">
    <h2 class="section-title">Registrar lote producido</h2>

    <div class="form-group-dark">
        <label>Producto</label>
        <select class="input-dark" bind:value={producto}>
    ...
    <div class="form-group-dark">
        ...
        <input class="input-dark" type="number" bind:value={cantidad} min="1" />
    </div>

    <div class="form-actions">
        <button onclick={agregarLote} class="btn btn-primary-dark">Guardar lote</button>
        <button onclick={() => goto('/defectos')} class="btn-cancel-dark">Volver al formulario Defectos</button>
    </div>
